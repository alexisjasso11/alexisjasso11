...
I'm a second year IT student with a passion for networking,
security, and cloud infrastructure. I learn by doing —
...
real world enterprise networking concepts including VLAN
segmentation, firewall management, trunking, DHCP configuration
and network troubleshooting.

### 🍓 [Pi-hole DNS Sinkhole — Raspberry Pi](https://github.com/alexisjasso11/Raspberry-Pi-DNS-Ad-Blocker)
Deployed a network wide DNS sinkhole using Pi-hole on a
Raspberry Pi to block ads and malicious domains at the
network level across all connected devices.
